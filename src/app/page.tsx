    ...
    <div className="bg-gradient-to-b from-teal-50 to-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center">
        ...
        <div className="absolute bottom-0 w-full">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#e6f7f9" fillOpacity="1" d="M0,224L48,202.7C96,181,192,139,288,128C384,117,480,139,576,138.7C672,139,768,117,864,138.7C960,160,1056,224,1152,224C1248,224,1344,160,1392,128L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-white bg-opacity-70 backdrop-blur-lg p-8 rounded-3xl shadow-xl">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              eco-friendly solutions that benefit both coastal communities and modern agriculture.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Transforming Coastal Communities</h2>
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="p-6">
              <div className="text-4xl font-bold text-teal-400 mb-2">₹50/kg</div>
