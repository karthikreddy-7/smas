      ...
      <section className="relative min-h-[70vh] flex items-center justify-center text-center px-4">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed animate-fade-in-up delay-100">
            Pioneering sustainable seaweed solutions while empowering coastal communities through marine innovation.
          </p>
        </div>
      </section>
          ...
          <div className="relative group animate-fade-in-right">
            ...
            <div className="relative bg-white p-10 rounded-3xl shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                Founded in 2025, SMAS emerged from a vision to revolutionize seaweed cultivation along India's coastal belts. What began as a community initiative has blossomed into a nationwide movement empowering thousands of coastal families.
              </p>
            </div>
          </div>
...
/>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[{
              ...
              icon: "🌱",
              description: "Maintaining marine ecosystem integrity through sustainable cultivation practices"
            }, {
              title: "Community First",
              icon: "👩‍🌾",
              description: "Empowering coastal families with 80% women participation in our workforce"
            }, {
              title: "Innovation Driven",
              icon: "🔬",
              description: "Combining traditional knowledge with modern marine biotechnology"
            }].map((value, index) => (
              <div key={index} className="p-6 bg-white/10 rounded-xl backdrop-blur-md hover:bg-white/20 transition duration-300">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-blue-900 mb-12">Our Impact Journey</h2>
          <div className="relative border-l-4 border-teal-500 pl-8">
            {[{
              year: "2025",
              title: "SMAS Foundation",
              content: "Established in Tamil Nadu with first 50 farming families"
            }, {
              year: "2027",
              title: "Tech Integration",
              content: "Implemented IoT-enabled cultivation monitoring systems"
            }, {
              year: "2029",
              title: "National Recognition",
              content: "Awarded Best Marine Agri-Initiative by Government of India"
            }, {
              year: "2030",
              title: "Global Expansion",
              content: "Launched international operations across 5 coastal nations"
            }].map((milestone, index) => (
              <div key={index} className="mb-12 relative pl-8 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <h3 className="text-xl font-semibold text-blue-900 mt-2">{milestone.title}</h3>
