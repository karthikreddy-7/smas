    ...
    <div className="bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4">
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto animate-fade-in-up delay-100">
            Partner with us to cultivate sustainable marine solutions and empower coastal communities
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8 animate-fade-in-left">
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-blue-50">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-900 mb-1">General Inquiries</h3>
                      <a href="mailto:contact@skandamarine.com" className="text-gray-600 hover:text-teal-600 transition">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-900 mb-1">Phone Support</h3>
                      <a href="tel:+914422556677" className="text-gray-600 hover:text-teal-600 transition">
                        +91 44 2255 6677
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-900 mb-1">Headquarters</h3>
                      <p className="text-gray-600">
                        Marine Algae Research Center<br />
              ...
              <div className="bg-blue-900 p-8 rounded-2xl text-white">
                <h3 className="text-2xl font-bold mb-4">B2B & Partnership Inquiries</h3>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-gray-600 mb-8">Trusted by coastal communities across India</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            <img src="/india-gov-logo.svg" alt="Govt of India" className="h-12 mx-auto opacity-75" />
            <img src="/marine-council-logo.svg" alt="Marine Council" className="h-16 mx-auto opacity-75" />
            <img src="/organic-certified-logo.svg" alt="Organic Certified" className="h-14 mx-auto opacity-75" />
            <img src="/women-empowerment-logo.svg" alt="Women Empowerment" className="h-12 mx-auto opacity-75" />
          </div>
        </div>
      </section>
    </div>
