  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-800 to-green-600 text-white">
      ...
      <section className="relative text-center py-16 px-6 sm:px-12">
        ...
        >
          Discover innovative and eco-friendly methods to cultivate seaweed in different marine environments.
        </motion.p>
        <motion.div
          ...
          {FARMING_METHODS.map((method, index) => (
            ...
            >
              ...
              <div className="h-48 bg-teal-700 flex items-center justify-center">
                {method.image ? (
                  <Image src={method.image} alt={method.title} width={300} height={200} className="object-cover" />
                ) : (
      ...
      {/* Call to Action */}
      <section className="text-center py-12 bg-teal-900 min-h-[90vh] flex flex-col items-center justify-center">
        <motion.h2
        ...
        <motion.p 
          ...
          transition={{ delay: 0.3, duration: 0.6 }}
        >
          Contact us to learn about sustainable farming techniques and how you can contribute to marine conservation.
        </motion.p>
        <motion.a
          href="/contact"
